        ...
        <div class="slimscroll-menu mt-5" id="remove-scroll">
            ...
            <div id="sidebar-menu">
                ...
                <ul class="metismenu" id="side-menu">
                    ...
                    <!-- <li>
                        <a href="javascript:void(0);" class="waves-effect"><i class="icon-spread"></i><span> Anggota <span class="float-right menu-arrow"><i class="mdi mdi-chevron-right"></i></span> </span></a>
                        <ul class="submenu">
                            <li><a href="tables-datatable.html">Anggota Baru</a></li>
                            <li><a href="<?= base_url('Admin/anggota_tetap') ?>">Anggota Tetap</a></li>
                        </ul>
                    </li> -->
